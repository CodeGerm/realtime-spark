#Apache Hadoop 2.7.1 Docker with Spark assembly image

_Note: this image is extension of sequenceiq/hadoop-docker. It has spark assembly deployed in hdfs://hadoop:9000/spark_jars/.
